/*! For license information please see tutorialv1.e1a6255882883797a6e5.js.LICENSE.txt */
(() => {
  var t,
    e,
    r,
    ...
    a = {
      ...
      1619: (t, e, r) => {
        ...
        const Q = [
            {
              title: "Andando pelo mapa 🚶",
              videoUrl:
                "https://b42-wa-assets.s3.amazonaws.com/ciaed/videos/V03+-+Intera%C3%A7%C3%A3o+De+cen%C3%A1rio.mp4",
              videoPoster:
                "https://b42-wa-assets.s3.amazonaws.com/ciaed/videos/thumb.png",
              description:
                "\n<h2>Usando o teclado</h2>\n<p>Pressione as teclas direcionais para caminhar.</p>\n<p>Dica: para correr, aperte shift + tecla direcional.</p>\n<h2>Com o mouse</h2>\n<p>Clique com o botão direito em qualquer lugar do mapa. Simples assim!</p>\n<h2>No smartphone</h2><p>Toque no joystick virtual e utilize o polegar para direcionar seu avatar</p>\n        ",
              shortTiltle:
                "",
            },
            {
              title: "Ajustando áudio e vídeo 💬",
              videoUrl:
                "https://b42-wa-assets.s3.amazonaws.com/ciaed/videos/V02-configurando+%C3%A1udio+e+v%C3%ADdeo.mp4",
              videoPoster:
                "https://backup-workadventure-db-prod.s3.eu-west-1.amazonaws.com/upload/tuto_video/step5-onboarding.png",
              description:
                "\n<p>É importante que você habilite seu microfone e sua câmera para ter uma experiência completa.</p>\n<p>Uma janela de permissão vai aparecer na sua tela. Caso isso não aconteça, procure nas configurações do seu navegador.</p>\n<p>📌<strong> Não se preocupe:</strong> você pode desabilitar essas opções a qualquer momento dentro da plataforma!</p>\n        ",
              shortTiltle: "",
            },
            {
              title: "Entrando nas salas interativas 🪑",
              videoUrl:
                "https://b42-wa-assets.s3.amazonaws.com/ciaed/videos/V04-Audit%C3%B3rio%2C+chat+e+rea%C3%A7%C3%B5es.mp4.mp4",
              videoPoster:
                "https://backup-workadventure-db-prod.s3.eu-west-1.amazonaws.com/upload/tuto_video/step3-onboarding.png",
              description:
                "\n<p>Você vai participar de videochamadas com outras pessoas nas salas interativas!</p>\n</p>Na barra inferior da tela, você pode abrir ou fechar seu microfone e sua câmera quando quiser.</p>\n</p>Para isso, verifique se habilitou o microfone e a câmera no seu navegador, conforme vimos na etapa anterior.</p>\n<p>Se tudo estiver pronto, clique abaixo para iniciar sua aventura! 🚀</p>",
              shortTiltle: "",
            },
          ],
          tt = (function (t, e = n) {
...
//# sourceMappingURL=tutorialv1.e1a6255882883797a6e5.js.map
